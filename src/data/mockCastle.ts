...
export const baseCastleRooms: CastleRoom[] = [
  {
    ...
    name: "로비",
    subtitle: "Lobby",
    role: "오늘 브리핑과 세린의 안내가 시작되는 공간",
    description: "공주와 세린이 하루를 시작하는 루멘 왕성의 중심 공간입니다.",
    image: "/assets/home-bg.png",
    route: "home",
    roomLevel: 3,
    isDiscovered: true,
    visitedCount: 24,
  ...
  },
  {
    ...
    subtitle: "Throne",
    role: "성장, 레벨, 업적, 보상 통계",
    description: "공주의 레벨, EXP, 업적, 보상, 완료 통계를 확인하는 성장 전용 공간입니다.",
  ...
  },
  {
    ...
    description: "회의, 프로젝트, 메인 Quest를 다루는 업무 중심 공간입니다.",
  ...
  },
  {
    ...
    subtitle: "Garden",
    role: "휴식과 감정 회복",
    description: "바람과 꽃, 세린의 조용한 멘트만 있는 비생산성 휴식 공간입니다.",
