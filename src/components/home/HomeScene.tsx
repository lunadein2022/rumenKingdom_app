      ...
      <div className="content-safe-area">
        <div className="lobby-layout">
          <div className="lobby-left-stack">
            <aside className="palace-panel lobby-brief-card">
            ...
            <aside className="palace-panel lobby-quest-card">
              <div className="mini-list-head">
                <h2>오늘의 Quest</h2>
          ...
          <div className="lobby-character-layer" aria-hidden="true">
            <img className="lobby-princess" src="/assets/princess-full-final.png" alt="" />
          </div>

          <aside className="palace-panel lobby-room-card">
            <div className="mini-list-head">
              <h2>왕궁 안쪽으로 이동</h2>
