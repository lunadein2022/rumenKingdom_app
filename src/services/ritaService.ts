...
export type RitaRequestAnalysis =
  ...
  | { kind: 'relationship'; name: string; organization: string; position: string; phone: string; email: string; address: string; social: string; memo: string; tags: string[]; reply: string }
